...
import { CarouselData } from "../../assets/data/product";
      ...
      <div>
        <Slider {...settings} ref={sliderRef}>
          {CarouselData.map((item) => (
            <div key={item.id} className="flex-shrink-0 p-2">
              <div className="rounded-[10px] border border-[#E5E2EE] bg-[#F8F7F3] md:w-[236px] lg:w-[430px]">
                <div className="flex w-full items-center justify-center rounded-t-[10px] border-b border-[#E5E2EE] bg-white md:h-[376px] lg:h-[510px]">
                  <img
                    src={item.image}
                    alt="Slider Img"
